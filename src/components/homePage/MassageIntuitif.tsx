      ...
      <InView onChange={(inView, entry)=> inView && setSectionInView(true)}>
        ...
        <motion.div variants={opacityBandeau} initial="initial" animate={sectionInView ? 'animate':''} >
          ...
          <div className={`${karla.className} text-white mt-10 italic text-justify tracking-wide text-lg lg:text-2xl px-2.5 lg:px-16`}>
            ...
            <p className='indent-5 mb-2.5 leading-10'>
              Par mon attention, j&apos;ai la facul&shy;té d&apos;entrer en con&shy;nexion avec le rece&shy;veur, l&apos;harmo&shy;nie du mas&shy;sage se crée grâce à la fa&shy;çon que j&apos;ai de m&apos;ajuster à la respi&shy;ra&shy;tion du mas&shy;sé. Je per&shy;çois des in&shy;for&shy;ma&shy;tions non ver&shy;bales qui me per&shy;met&shy;tent de com&shy;pren&shy;dre si je dois pas&shy;ser plus de temps sur tel&shy;les par&shy;ties du corps a&shy;fin de le li&shy;bé&shy;rer de toutes ten&shy;sions ou d&apos;uti&shy;liser tel&shy;les tech&shy;niques pour vous ac&shy;compagner à lâcher pri&shy;se...
            </p>
            <p className='indent-5 mb-2.5 leading-10'>
              Ce massage person&shy;nalisé et com&shy;plet à base d&apos;huiles es&shy;sen&shy;tiel&shy;les bio&shy;lo&shy;gi&shy;ques, prend en compte l&apos;ap&shy;proche glo&shy;bale de l&apos;être hu&shy;main et le tou&shy;che dans ses dif&shy;féren&shy;tes di&shy;men&shy;sions (phy&shy;sique, men&shy;tale, émo&shy;tion&shy;nelle et éner&shy;gé&shy;tique) a&shy;fin que cel&shy;les-ci soient ré&shy;har&shy;moni&shy;sées. Tous mes soins sont ani&shy;més par la phi&shy;lo&shy;so&shy;phie du mas&shy;sage in&shy;tui&shy;tif.
            </p>
          </div>
        </motion.div>
      </InView>
