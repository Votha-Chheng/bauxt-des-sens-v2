...
const LogoFooter: FC = () => {
  return (
    <section className="flex flex-col items-center py-4 px-10 min-w-[400px] ">
      ...
      <h3
        className={`text-lg mt-1 pb-3 px-4 border-t-transparent border-deep-green border ${karla.className}`}
