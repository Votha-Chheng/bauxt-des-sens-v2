...
export const massageListe: Prestation[] = [
  {
  ...
  },
  {
    ...
    massages: [
      {
        service : "Soin visage 45mn",
        prix : "60",
        description : "Soins pour le visage constitué d'un gommage, masque, modelage et crème de soin."
      },
      {
        service : "Kobido - Massage japonais du visage 60mn",
        prix : "90",
        description : "Soin liftant anti-rides. Stimule l’ensemble de la circulation sanguine du visage et du cou. Lutte contre le vieillissement de la peau et améliore le teint."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    massages: [
      {
        service : "Intervention en entreprise",
        prix : "Tarif sur demande",
        description : "Pour faire découvrir les bienfaits du massage à vos salariés ou juste pour une pause détente, Baux'T des sens se déplace sur vos lieux de travail. N'hésitez pas à me contacter pour un service sur-mesure."
      },
      {
        service : "Intervention en résidence seniors",
        prix : "Tarif sur demande",
        description : "Parce que nos seniors ont besoin des bénéfices liés au massage, Baux'T des sens se déplace aussi dans les résidences seniors. N'hésitez pas à me contacter pour un service sur-mesure."
      },
      {
        service : "Evènements particuliers (EVJF, EVG, anniversaires, carte cadeau, etc...)",
        prix : "Tarif sur demande",
